          ...
          <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex ">
              ...
              <div className="p-5">
                ...
                <span className="text-gray-500 ">Air Pollution Expert (PhD, IIT Madras)</span>
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex ">
              ...
              <div className="p-5">
                ...
                <span className="text-gray-500 ">Climate Change Expert (PhD, University of Surrey, UK)</span>
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex ">
              ...
              <div className="p-5">
                ...
                <span className="text-gray-500 ">Air Pollution and SWM Expert (MS Research, IIT Bombay)</span>
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex ">
              ...
              <div className="p-5">
                ...
                <span className="text-gray-500 ">Waste Management & LCA Expert (PhD IIT Bombay)</span>
