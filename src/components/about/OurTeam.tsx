    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-6 mx-auto sm:px-28 lg:px-28  ">
          <div className=" w-full  mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight text-[#003e52] dark:text-white inline-block border-b-4 border-b-green-500 pb-1">Our Team</h2>
            <p className="font-light text-[#003e52] mb-5  sm:text-lg dark:text-gray-400">The AES is founded by a team of Senior Environmental and Sustainability experts, and alumini of IIT Bombay, NIT Karnataka, Surathkal and NIO-CSIR Goa. The core team’s extensive experience includes working on small to large clients in the area of:</p>
